<header class="border-b bg-white">
    <div class="max-w-7xl mx-auto px-4 py-3 flex items-center gap-4">
        ...
        <nav class="ml-auto hidden md:flex gap-4">
            ...
            <a href="{{ route('shop.category', ['slug' => 'ninos']) }}">Niños/Niñas</a>
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('shop.cart') }}" class="relative p-2 rounded hover:bg-gray-100" title="Carrito">
                ...
                <span id="cart-count" class="absolute -top-1 -right-1 text-xs bg-pink-600 text-white rounded-full px-1.5 py-0.5">0</span>
            </a>
        </div>
    </div>
</header>
